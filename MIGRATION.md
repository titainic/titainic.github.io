...
- Mermaid support: first-class support for [Mermaid](https://mermaid.js.org/) - a JavaScript-based diagram and charting tool supported by GitHub - has been added to the theme. **This feature is opt-in.** See the new doc subsections in   for more.
...
We've added several custom `_includes` to provide users with more customization options for different site elements. We've also added a section to to outline these.
...
In addition to customizing the search placeholder, we've also added the ability to provide custom content to the search index. for more, see . PR: [#1068].
...
- Links wrap. PR: [#905]
- Callouts: a new component similar to alerts or banners. See . PR: [#466]
